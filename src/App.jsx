...
const ML_LOCATION_INTEL = {
  "Cape Schanck Lighthouse": {
    totalRecords: 1314,
    peakMonths: [7, 6, 3],
    topSpecies: [{"name":"White-capped Albatross","count":165,"peakMonths":[7, 6, 8],"behaviors":["Flying", "Foraging or Eating"]}, {"name":"Australasian Gannet","count":160,"peakMonths":[7, 6, 3],"behaviors":["Flying"]}, {"name":"Singing Honeyeater","count":126,"peakMonths":[7, 6, 2],"behaviors":["Preening, Scratching, or Bathing", "Flying"]}, {"name":"Kelp Gull","count":83,"peakMonths":[7, 6, 2],"behaviors":["Flying"]}, {"name":"Pacific Gull","count":82,"peakMonths":[7, 6, 3],"behaviors":["Flying"]}, {"name":"Peregrine Falcon","count":74,"peakMonths":[7, 6, 8],"behaviors":["Flying", "Preening, Scratching, or Bathing"]}, {"name":"Short-tailed Shearwater","count":69,"peakMonths":[2, 3, 1],"behaviors":["Flying"]}, {"name":"Gray Shrikethrush","count":66,"peakMonths":[7, 6, 10],"behaviors":[]}, {"name":"Spiny-cheeked Honeyeater","count":57,"peakMonths":[2, 1, 4],"behaviors":[]}, {"name":"Black-browed Albatross","count":47,"peakMonths":[7, 8, 9],"behaviors":["Flying"]}],
    allSpecies: ["Australasian Gannet", "Australian Magpie", "Australian Shelduck", "Black Swan", "Black-browed Albatross", "Black-faced Cormorant", "Black-shouldered Kite", "Brown Falcon", "Brown Thornbill", "Crescent Honeyeater", "Crimson Rosella", "Eastern Spinebill", "Eastern Yellow Robin", "Eurasian Blackbird", "European Starling", "Fluttering Shearwater", "Gray Butcherbird", "Gray Fantail", "Gray Shrikethrush", "Great Cormorant", "Great Crested Tern", "Hooded Plover", "Hutton's Shearwater", "Kelp Gull", "Little Black Cormorant", "Little Pied Cormorant", "Little Wattlebird", "Mistletoebird", "Nankeen Kestrel", "New Holland Honeyeater", "Northern Giant-Petrel", "Pacific Gull", "Peregrine Falcon", "Peregrine Falcon (Australian)", "Pied Cormorant", "Pink Robin", "Red Wattlebird", "Short-tailed Shearwater", "Silver Gull", "Silver Gull (Silver)", "Silvereye", "Singing Honeyeater", "Sooty Oystercatcher", "Sooty Shearwater", "Sooty/Short-tailed Shearwater", "Southern Fulmar", "Southern Giant-Petrel", "Southern/Northern Giant-Petrel", "Spiny-cheeked Honeyeater", "Spotted Dove"],
  },
  "Coolart Wetlands": {
    totalRecords: 1122,
    peakMonths: [1, 2, 4],
    topSpecies: [{"name":"Red-capped Plover","count":88,"peakMonths":[11, 1, 4],"behaviors":[]}, {"name":"Australasian Shoveler","count":45,"peakMonths":[1, 2, 4],"behaviors":[]}, {"name":"Chestnut Teal","count":32,"peakMonths":[1, 2, 3],"behaviors":[]}, {"name":"Australasian Swamphen","count":31,"peakMonths":[1, 2, 5],"behaviors":[]}, {"name":"Little Pied Cormorant","count":29,"peakMonths":[1, 2, 3],"behaviors":[]}, {"name":"Little Wattlebird","count":28,"peakMonths":[1, 10, 2],"behaviors":[]}, {"name":"Gray Teal","count":27,"peakMonths":[2, 1, 3],"behaviors":[]}, {"name":"Australian Ibis","count":25,"peakMonths":[1, 9, 10],"behaviors":[]}, {"name":"Fan-tailed Cuckoo","count":24,"peakMonths":[1, 12, 9],"behaviors":["Song"]}, {"name":"Silvereye","count":24,"peakMonths":[2, 1, 10],"behaviors":[]}],
    allSpecies: ["Australasian Darter", "Australasian Grebe", "Australasian Shoveler", "Australasian Swamphen", "Australian Crake", "Australian Ibis", "Australian King-Parrot", "Australian Magpie", "Australian Pipit", "Australian Raven", "Australian Reed Warbler", "Black Swan", "Black-faced Cuckooshrike", "Black-fronted Dotterel", "Black-shouldered Kite", "Black-tailed Nativehen", "Blue-billed Duck", "Brown Goshawk", "Brown Thornbill", "Brown-headed Honeyeater", "Buff-banded Rail", "Caspian Tern", "Chestnut Teal", "Common Bronzewing", "Crescent Honeyeater", "Crimson Rosella", "Crimson Rosella (Crimson)", "Double-banded Plover", "Dusky Moorhen", "Dusky Woodswallow", "Eastern Rosella", "Eastern Spinebill", "Eastern Yellow Robin", "Eurasian Blackbird", "Eurasian Coot", "European Goldfinch", "European Starling", "Fan-tailed Cuckoo", "Freckled Duck", "Galah", "Golden Whistler", "Golden Whistler (Eastern)", "Golden-headed Cisticola", "Gray Butcherbird", "Gray Currawong", "Gray Fantail", "Gray Fantail (alisteri)", "Gray Shrikethrush", "Gray Teal", "Great Cormorant"],
  },
  "Tootgarook Wetlands": {
    totalRecords: 846,
    peakMonths: [1, 2, 3],
    topSpecies: [{"name":"Eastern Yellow Robin","count":54,"peakMonths":[1, 12, 6],"behaviors":[]}, {"name":"Pacific Black Duck","count":47,"peakMonths":[1, 3, 2],"behaviors":[]}, {"name":"Black-fronted Dotterel","count":30,"peakMonths":[2, 12, 1],"behaviors":[]}, {"name":"Great Cormorant","count":30,"peakMonths":[1, 12, 9],"behaviors":[]}, {"name":"Latham's Snipe","count":30,"peakMonths":[2, 1, 12],"behaviors":[]}, {"name":"Freckled Duck","count":27,"peakMonths":[12, 3, 4],"behaviors":[]}, {"name":"Red-browed Firetail","count":25,"peakMonths":[10, 3, 2],"behaviors":[]}, {"name":"Australasian Swamphen","count":24,"peakMonths":[1, 12, 2],"behaviors":[]}, {"name":"Dusky Moorhen","count":22,"peakMonths":[2, 1, 4],"behaviors":[]}, {"name":"Fairy Martin","count":21,"peakMonths":[1, 12, 9],"behaviors":[]}],
    allSpecies: ["Australasian Grebe", "Australasian Shoveler", "Australasian Swamphen", "Australian Ibis", "Australian Magpie", "Australian Pipit", "Australian Reed Warbler", "Australian Shelduck", "Black Swan", "Black-faced Cuckooshrike", "Black-fronted Dotterel", "Black-shouldered Kite", "Brown Thornbill", "Cape Barren Goose", "Chestnut Teal", "Common Myna", "Crested Pigeon", "Crimson Rosella", "Dusky Moorhen", "Eastern Rosella", "Eastern Spinebill", "Eastern Yellow Robin", "Eurasian Blackbird", "Eurasian Coot", "European Goldfinch", "European Starling", "Fairy Martin", "Fairy/Tree Martin", "Fan-tailed Cuckoo", "Flame Robin", "Freckled Duck", "Galah", "Golden Whistler", "Golden Whistler (Eastern)", "Gray Butcherbird", "Gray Fantail", "Gray Shrikethrush", "Gray Teal", "Great Cormorant", "Great Egret", "Hardhead", "Hoary-headed Grebe", "Horsfield's Bronze-Cuckoo", "Latham's Snipe", "Laughing Kookaburra", "Little Black Cormorant", "Little Egret", "Little Pied Cormorant", "Little Raven", "Little Wattlebird"],
  },
  "Flinders Blowhole": {
    totalRecords: 616,
    peakMonths: [7, 1, 3],
    topSpecies: [{"name":"Hooded Plover","count":113,"peakMonths":[7, 3, 4],"behaviors":["Foraging or Eating"]}, {"name":"Sooty Oystercatcher","count":72,"peakMonths":[7, 3, 1],"behaviors":["Foraging or Eating", "Carrying Food", "Flying"]}, {"name":"Double-banded Plover","count":61,"peakMonths":[7, 4, 2],"behaviors":[]}, {"name":"Red-necked Stint","count":57,"peakMonths":[7, 4, 1],"behaviors":["Foraging or Eating"]}, {"name":"Ruddy Turnstone","count":47,"peakMonths":[3, 4, 2],"behaviors":["Foraging or Eating"]}, {"name":"Great Cormorant","count":22,"peakMonths":[10, 1, 2],"behaviors":["Preening, Scratching, or Bathing", "Flying"]}, {"name":"Pacific Gull","count":19,"peakMonths":[1, 2, 12],"behaviors":["Flying"]}, {"name":"Silver Gull","count":18,"peakMonths":[1, 2, 9],"behaviors":["Flying"]}, {"name":"Little Pied Cormorant","count":17,"peakMonths":[1, 12, 3],"behaviors":[]}, {"name":"Great Crested Tern","count":16,"peakMonths":[10, 1, 3],"behaviors":["Flying"]}],
    allSpecies: ["Australasian Gannet", "Australian Ibis", "Australian Magpie", "Australian Pipit", "Black-faced Cormorant", "Black-shouldered Kite", "Brown Falcon", "Chestnut Teal", "Double-banded Plover", "Eurasian Blackbird", "European Starling", "Gray Teal", "Great Cormorant", "Great Crested Tern", "Hooded Plover", "House Sparrow", "Kelp Gull", "Little Black Cormorant", "Little Corella", "Little Pied Cormorant", "Little Raven", "Little Wattlebird", "Magpie-lark", "Noisy Miner", "Pacific Gull", "Peregrine Falcon", "Pied Cormorant", "Red Wattlebird", "Red-capped Plover", "Red-necked Stint", "Ruddy Turnstone", "Sanderling", "Short-tailed Shearwater", "Silver Gull", "Silvereye", "Singing Honeyeater", "Sooty Oystercatcher", "Spiny-cheeked Honeyeater", "Superb Fairywren", "Welcome Swallow", "White-bellied Sea-Eagle", "White-browed Scrubwren", "White-capped Albatross", "White-faced Heron", "Willie-wagtail"],
  },
  "Moorooduc Quarry": {
    totalRecords: 357,
    peakMonths: [10, 11, 8],
    topSpecies: [{"name":"Peregrine Falcon","count":169,"peakMonths":[11, 10, 8],"behaviors":["Flying", "Feeding Young", "Preening, Scratching, or Bathing"]}, {"name":"Laughing Kookaburra","count":17,"peakMonths":[12, 8, 7],"behaviors":["Flying"]}, {"name":"Eastern Yellow Robin","count":13,"peakMonths":[11, 3, 10],"behaviors":["Nest Building"]}, {"name":"Golden Whistler","count":13,"peakMonths":[11, 1, 10],"behaviors":["Flying"]}, {"name":"White-eared Honeyeater","count":9,"peakMonths":[8, 10],"behaviors":["Foraging or Eating"]}, {"name":"Black-faced Cuckooshrike","count":8,"peakMonths":[10, 11],"behaviors":["Flying"]}, {"name":"Brown Thornbill","count":8,"peakMonths":[8, 9, 10],"behaviors":["Flying"]}, {"name":"Pacific Black Duck","count":7,"peakMonths":[1, 10],"behaviors":[]}, {"name":"Mistletoebird","count":7,"peakMonths":[10, 1, 11],"behaviors":["Vocalizing"]}, {"name":"Fan-tailed Cuckoo","count":7,"peakMonths":[10, 12],"behaviors":["Vocalizing", "Flying"]}],
    allSpecies: ["Bell Miner", "Black-faced Cuckooshrike", "Brown Goshawk", "Brown Thornbill", "Common Bronzewing", "Common Myna", "Eastern Rosella", "Eastern Spinebill", "Eastern Yellow Robin", "Eurasian Blackbird", "European Starling", "Fan-tailed Cuckoo", "Galah", "Golden Whistler", "Golden Whistler (Eastern)", "Gray Butcherbird", "Gray Fantail", "Gray Shrikethrush", "Great Cormorant", "Laughing Kookaburra", "Little Raven", "Maned Duck", "Mistletoebird", "Noisy Miner", "Pacific Black Duck", "Peregrine Falcon", "Pied Currawong", "Red Wattlebird", "Red-browed Firetail", "Rufous Whistler", "Shining Bronze-Cuckoo", "Shining Bronze-Cuckoo (Golden)", "Silvereye", "Spotted Dove", "Spotted Pardalote", "Straw-necked Ibis", "Striated Pardalote (Eastern)", "Striated Thornbill", "Superb Fairywren", "Swamp Harrier", "White-browed Scrubwren", "White-eared Honeyeater", "White-naped Honeyeater", "Yellow-faced Honeyeater"],
  },
  "Arthurs Seat Ridge": {
    totalRecords: 344,
    peakMonths: [1, 10, 2],
    topSpecies: [{"name":"Yellow-faced Honeyeater","count":33,"peakMonths":[1, 12, 2],"behaviors":[]}, {"name":"Red-browed Firetail","count":33,"peakMonths":[1, 2, 12],"behaviors":[]}, {"name":"Silvereye","count":32,"peakMonths":[1, 10, 12],"behaviors":[]}, {"name":"Eastern Spinebill","count":21,"peakMonths":[1, 10, 2],"behaviors":[]}, {"name":"Superb Fairywren","count":20,"peakMonths":[1, 2, 10],"behaviors":[]}, {"name":"Australian Rufous Fantail","count":18,"peakMonths":[1, 2, 12],"behaviors":[]}, {"name":"White-browed Scrubwren","count":15,"peakMonths":[1, 10, 12],"behaviors":[]}, {"name":"Eastern Yellow Robin","count":14,"peakMonths":[1, 3, 10],"behaviors":[]}, {"name":"Brown-headed Honeyeater","count":14,"peakMonths":[1, 2, 12],"behaviors":[]}, {"name":"Brown Thornbill","count":13,"peakMonths":[10, 1, 3],"behaviors":[]}],
    allSpecies: ["Australian Rufous Fantail", "Brown Thornbill", "Brown-headed Honeyeater", "Crescent Honeyeater", "Crimson Rosella", "Eastern Spinebill", "Eastern Yellow Robin", "Eurasian Blackbird", "Golden Whistler", "Golden Whistler (Eastern)", "Gray Fantail", "Gray Shrikethrush", "Laughing Kookaburra", "Maned Duck", "New Holland Honeyeater", "Red Wattlebird", "Red-browed Firetail", "Rufous Whistler", "Satin Flycatcher", "Silvereye", "Spotted Pardalote", "Striated Thornbill", "Superb Fairywren", "White-browed Scrubwren", "White-eared Honeyeater", "White-naped Honeyeater", "White-throated Treecreeper", "Yellow-faced Honeyeater"],
  },
  "Devilbend Reservoir": {
    totalRecords: 223,
    peakMonths: [10, 1, 7],
    topSpecies: [{"name":"White-bellied Sea-Eagle","count":22,"peakMonths":[10],"behaviors":["Flying", "Foraging or Eating", "Carrying Food; Flying"]}, {"name":"Australian Pelican","count":13,"peakMonths":[7, 10, 1],"behaviors":["Preening, Scratching, or Bathing", "Flying"]}, {"name":"Blue-billed Duck","count":13,"peakMonths":[12],"behaviors":[]}, {"name":"Caspian Tern","count":12,"peakMonths":[10, 7],"behaviors":["Flying"]}, {"name":"Hoary-headed Grebe","count":12,"peakMonths":[10, 7],"behaviors":["Flying"]}, {"name":"Great Cormorant","count":11,"peakMonths":[12, 10, 3],"behaviors":["Flying"]}, {"name":"Musk Duck","count":10,"peakMonths":[12, 10, 11],"behaviors":[]}, {"name":"Black Swan","count":8,"peakMonths":[1, 12, 10],"behaviors":[]}, {"name":"Straw-necked Ibis","count":7,"peakMonths":[10, 11],"behaviors":["Flying"]}, {"name":"Maned Duck","count":7,"peakMonths":[1, 10],"behaviors":[]}],
    allSpecies: ["Australasian Swamphen", "Australian Ibis", "Australian Magpie", "Australian Pelican", "Australian Rufous Fantail", "Australian Shelduck", "Black Swan", "Black-shouldered Kite", "Blue-billed Duck", "Brown Thornbill", "Brush Bronzewing", "Cape Barren Goose", "Caspian Tern", "Common Bronzewing", "Common Myna", "Crimson Rosella", "Dusky Moorhen", "Dusky Woodswallow", "Eastern Rosella", "Eastern Yellow Robin", "Eurasian Coot", "Flame Robin", "Golden Whistler", "Golden Whistler (Eastern)", "Gray Butcherbird", "Gray Fantail", "Gray Shrikethrush", "Great Cormorant", "Great Crested Grebe", "Great Egret", "Hoary-headed Grebe", "Little Grassbird", "Little Pied Cormorant", "Little Raven", "Maned Duck", "Masked Lapwing", "Musk Duck", "Noisy Miner", "Pacific Black Duck", "Pied Cormorant", "Red Wattlebird", "Straw-necked Ibis", "Striated Thornbill", "Superb Fairywren", "Swamp Harrier", "Whistling Kite", "White-bellied Sea-Eagle", "White-browed Scrubwren", "White-eared Honeyeater", "White-faced Heron"],
  },
  "Greens Bush, Mornington NP": {
    totalRecords: 176,
    peakMonths: [1, 8, 12],
    topSpecies: [{"name":"Australian Rufous Fantail","count":30,"peakMonths":[1, 2, 11],"behaviors":[]}, {"name":"Eastern Yellow Robin","count":28,"peakMonths":[1, 12, 5],"behaviors":[]}, {"name":"Sacred Kingfisher","count":20,"peakMonths":[1, 12, 11],"behaviors":[]}, {"name":"Varied Sittella","count":15,"peakMonths":[1, 6, 12],"behaviors":[]}, {"name":"White-throated Treecreeper","count":14,"peakMonths":[1, 6, 8],"behaviors":[]}, {"name":"Brown Thornbill","count":13,"peakMonths":[1, 8, 5],"behaviors":[]}, {"name":"Crescent Honeyeater","count":11,"peakMonths":[2, 8, 6],"behaviors":[]}, {"name":"Bassian Thrush","count":10,"peakMonths":[6, 7],"behaviors":[]}, {"name":"Pink Robin","count":10,"peakMonths":[5, 7],"behaviors":[]}, {"name":"Crimson Rosella","count":10,"peakMonths":[1, 8, 5],"behaviors":[]}],
    allSpecies: ["Australasian Grebe", "Australian Boobook (Boobook)", "Australian King-Parrot", "Australian Rufous Fantail", "Bassian Thrush", "Black-faced Cuckooshrike", "Brown Thornbill", "Brush Bronzewing", "Common Bronzewing", "Crescent Honeyeater", "Crimson Rosella", "Eastern Rosella", "Eastern Spinebill", "Eastern Yellow Robin", "Eurasian Blackbird", "Fan-tailed Cuckoo", "Flame Robin", "Golden Whistler (Eastern)", "Gray Butcherbird", "Gray Fantail", "Gray Shrikethrush", "Laughing Kookaburra", "Little Corella", "Little Wattlebird", "Mistletoebird", "Pacific Black Duck", "Pink Robin", "Powerful Owl", "Red-browed Firetail", "Rufous Whistler", "Sacred Kingfisher", "Satin Flycatcher", "Scarlet Robin", "Silvereye", "Striated Thornbill", "Superb Fairywren", "Varied Sittella", "White-browed Scrubwren", "White-eared Honeyeater", "White-naped Honeyeater", "White-throated Treecreeper", "Yellow-faced Honeyeater"],
  },
  "Point Nepean National Park": {
    totalRecords: 127,
    peakMonths: [1, 10, 9],
    topSpecies: [{"name":"Sooty Oystercatcher","count":30,"peakMonths":[1, 11, 10],"behaviors":[]}, {"name":"Hooded Plover","count":15,"peakMonths":[10, 1, 12],"behaviors":[]}, {"name":"Peregrine Falcon","count":15,"peakMonths":[12, 10, 11],"behaviors":[]}, {"name":"Gray Shrikethrush","count":10,"peakMonths":[9, 11, 8],"behaviors":[]}, {"name":"Pacific Gull","count":9,"peakMonths":[1, 9, 8],"behaviors":[]}, {"name":"Great Cormorant","count":7,"peakMonths":[1, 10, 12],"behaviors":[]}, {"name":"Black-faced Cormorant","count":6,"peakMonths":[1, 9],"behaviors":[]}, {"name":"Australasian Gannet","count":6,"peakMonths":[1, 9],"behaviors":[]}, {"name":"Yellow-faced Honeyeater","count":3,"peakMonths":[11, 1],"behaviors":[]}, {"name":"Nankeen Kestrel","count":3,"peakMonths":[2, 1],"behaviors":[]}],
    allSpecies: ["Australasian Gannet", "Australian Magpie", "Black-faced Cormorant", "Gray Fantail", "Gray Shrikethrush", "Great Cormorant", "Great Crested Tern", "Hooded Plover", "Little Black Cormorant", "Little Pied Cormorant", "Musk Lorikeet", "Nankeen Kestrel", "Pacific Gull", "Peregrine Falcon", "Pied Cormorant", "Short-tailed Shearwater", "Silver Gull", "Singing Honeyeater", "Sooty Oystercatcher", "Spiny-cheeked Honeyeater", "Striated Fieldwren", "Welcome Swallow", "White-browed Scrubwren", "White-faced Heron", "Yellow-faced Honeyeater"],
  },
  "Western Port Bay \u2013 Tooradin": {
    totalRecords: 330,
    peakMonths: [1, 2, 4],
    topSpecies: [{"name":"Australian Pelican","count":58,"peakMonths":[1, 2, 3],"behaviors":[]}, {"name":"Pacific Gull","count":27,"peakMonths":[2, 1, 9],"behaviors":[]}, {"name":"Nankeen Night Heron","count":18,"peakMonths":[1, 2, 9],"behaviors":[]}, {"name":"Great Egret","count":15,"peakMonths":[1, 2, 5],"behaviors":[]}, {"name":"White-faced Heron","count":15,"peakMonths":[2, 1, 3],"behaviors":[]}, {"name":"Pied Oystercatcher","count":15,"peakMonths":[1, 2, 4],"behaviors":[]}, {"name":"Little Pied Cormorant","count":12,"peakMonths":[2, 8, 1],"behaviors":[]}, {"name":"Royal Spoonbill","count":11,"peakMonths":[2, 4, 1],"behaviors":[]}, {"name":"Australian Ibis","count":11,"peakMonths":[4, 1, 5],"behaviors":[]}, {"name":"Maned Duck","count":11,"peakMonths":[1, 9, 6],"behaviors":[]}],
    allSpecies: ["Australasian Gannet", "Australian Ibis", "Australian Pelican", "Australian Raven", "Black Swan", "Black-shouldered Kite", "Brown Thornbill", "Caspian Tern", "Chestnut Teal", "Common Bronzewing", "Crested Pigeon", "Crimson Rosella", "Eastern Rosella", "European Starling", "Fan-tailed Cuckoo", "Far Eastern Curlew", "Gray Butcherbird", "Gray Currawong", "Gray Teal", "Great Crested Grebe", "Great Crested Tern", "Great Egret", "Laughing Kookaburra", "Little Black Cormorant", "Little Egret", "Little Pied Cormorant", "Little Wattlebird", "Magpie-lark", "Maned Duck", "Masked Lapwing", "Masked Lapwing (Black-shouldered)", "Musk Lorikeet", "Nankeen Kestrel", "Nankeen Night Heron", "New Holland Honeyeater", "Noisy Miner", "Pacific Gull", "Pied Cormorant", "Pied Oystercatcher", "Rainbow Lorikeet", "Royal Spoonbill", "Silver Gull", "Silvereye", "Spiny-cheeked Honeyeater", "Spotted Dove", "Straw-necked Ibis", "Superb Fairywren", "Welcome Swallow", "White-eared Honeyeater", "White-faced Heron"],
  },
  "Safety Beach Foreshore": {
    totalRecords: 2,
    peakMonths: [1],
    topSpecies: [{"name":"Silver Gull","count":2,"peakMonths":[1],"behaviors":[]}],
    allSpecies: ["Silver Gull"],
  },
  "Bittern Reservoir": {
    totalRecords: 495,
    peakMonths: [2, 4, 1],
    topSpecies: [{"name":"Blue-billed Duck","count":27,"peakMonths":[12, 9, 8],"behaviors":["Call"]}, {"name":"Black-fronted Dotterel","count":23,"peakMonths":[12, 9, 5],"behaviors":[]}, {"name":"Hoary-headed Grebe","count":23,"peakMonths":[12, 6, 11],"behaviors":["Call"]}, {"name":"Pied Stilt","count":21,"peakMonths":[5, 3, 2],"behaviors":[]}, {"name":"Australian Reed Warbler","count":20,"peakMonths":[2, 12, 1],"behaviors":[]}, {"name":"Yellow-billed Spoonbill","count":19,"peakMonths":[1, 2, 12],"behaviors":[]}, {"name":"White-fronted Chat","count":16,"peakMonths":[4, 2, 3],"behaviors":[]}, {"name":"Black Swan","count":16,"peakMonths":[2, 1, 12],"behaviors":[]}, {"name":"Musk Duck","count":15,"peakMonths":[1, 12, 4],"behaviors":[]}, {"name":"Little Pied Cormorant","count":14,"peakMonths":[2, 12, 4],"behaviors":[]}],
    allSpecies: ["Australasian Grebe", "Australasian Shoveler", "Australasian Swamphen", "Australian Crake", "Australian Hobby", "Australian Ibis", "Australian Magpie", "Australian Pelican", "Australian Reed Warbler", "Australian Rufous Fantail", "Australian Shelduck", "Black Swan", "Black-backed Bittern", "Black-faced Cuckooshrike", "Black-fronted Dotterel", "Black-shouldered Kite", "Blue-billed Duck", "Brown-headed Honeyeater", "Brush Bronzewing", "Cape Barren Goose", "Caspian Tern", "Common Bronzewing", "Crimson Rosella", "Dusky Woodswallow", "Eastern Shrike-tit", "Eastern Spinebill", "Eastern Yellow Robin", "Eurasian Coot", "Flame Robin", "Freckled Duck", "Golden Whistler", "Golden Whistler (Eastern)", "Gray Butcherbird", "Gray Currawong", "Gray Fantail", "Gray Shrikethrush", "Gray Teal", "Great Cormorant", "Great Crested Grebe", "Great Egret", "Hardhead", "Hoary-headed Grebe", "Little Black Cormorant", "Little Grassbird", "Little Pied Cormorant", "Little Wattlebird", "Maned Duck", "Masked Lapwing", "Mistletoebird", "Musk Duck"],
  },
  "Warringine Park": {
    totalRecords: 365,
    peakMonths: [12, 2, 1],
    topSpecies: [{"name":"Striated Fieldwren","count":39,"peakMonths":[1, 2, 12],"behaviors":[]}, {"name":"Swamp Harrier","count":29,"peakMonths":[12, 2, 9],"behaviors":[]}, {"name":"White-faced Heron","count":29,"peakMonths":[1, 12, 2],"behaviors":[]}, {"name":"Superb Fairywren","count":18,"peakMonths":[1, 6, 2],"behaviors":[]}, {"name":"Black Swan","count":18,"peakMonths":[12, 6, 5],"behaviors":[]}, {"name":"Royal Spoonbill","count":18,"peakMonths":[2, 12, 8],"behaviors":[]}, {"name":"Australian Crake","count":14,"peakMonths":[1, 2, 5],"behaviors":[]}, {"name":"Spotless Crake","count":13,"peakMonths":[2, 1],"behaviors":[]}, {"name":"Great Egret","count":12,"peakMonths":[8, 2, 9],"behaviors":[]}, {"name":"White-eared Honeyeater","count":12,"peakMonths":[12, 5, 7],"behaviors":[]}],
    allSpecies: ["Australian Crake", "Australian Hobby", "Australian Ibis", "Australian Magpie", "Australian Pelican", "Australian Shelduck", "Baillon's Crake", "Black Swan", "Black-faced Cuckooshrike", "Black-shouldered Kite", "Brown Thornbill", "Buff-banded Rail", "Chestnut Teal", "Common Bronzewing", "Crested Pigeon", "Eastern Rosella", "Eurasian Blackbird", "European Starling", "Golden-headed Cisticola", "Gray Butcherbird", "Gray Fantail", "Gray Shrikethrush", "Gray Teal", "Great Egret", "Horsfield's Bronze-Cuckoo", "House Sparrow", "Lewin's Rail", "Little Corella", "Little Grassbird", "Little Raven", "Little Wattlebird", "Magpie-lark", "Masked Lapwing", "Nankeen Kestrel", "New Holland Honeyeater", "Pacific Black Duck", "Rainbow Lorikeet", "Red Wattlebird", "Royal Spoonbill", "Rufous Whistler", "Sacred Kingfisher", "Shining Bronze-Cuckoo", "Silver Gull", "Silvereye", "Spotless Crake", "Spotted Dove", "Straw-necked Ibis", "Striated Fieldwren", "Superb Fairywren", "Swamp Harrier"],
  },
  "Point Leo": {
    totalRecords: 150,
    peakMonths: [8, 1, 9],
    topSpecies: [{"name":"Red-capped Plover","count":43,"peakMonths":[8, 1, 9],"behaviors":[]}, {"name":"Hooded Plover","count":20,"peakMonths":[9, 8, 1],"behaviors":[]}, {"name":"Double-banded Plover","count":18,"peakMonths":[9, 8],"behaviors":[]}, {"name":"Eurasian Coot","count":10,"peakMonths":[11, 8],"behaviors":[]}, {"name":"Red-necked Stint","count":8,"peakMonths":[8, 1, 9],"behaviors":[]}, {"name":"Chestnut Teal","count":7,"peakMonths":[8, 11, 10],"behaviors":[]}, {"name":"Silver Gull","count":6,"peakMonths":[11, 10, 9],"behaviors":[]}, {"name":"Caspian Tern","count":4,"peakMonths":[11, 10],"behaviors":[]}, {"name":"Musk Lorikeet","count":4,"peakMonths":[1],"behaviors":[]}, {"name":"Eastern Rosella","count":3,"peakMonths":[1, 10],"behaviors":[]}],
    allSpecies: ["Australian Ibis", "Australian Magpie", "Caspian Tern", "Chestnut Teal", "Common Bronzewing", "Crimson Rosella", "Double-banded Plover", "Eastern Rosella", "Eurasian Coot", "European Starling", "Gray Fantail", "Gray Teal", "Hooded Plover", "Little Pied Cormorant", "Little Raven", "Little Wattlebird", "Masked Lapwing", "Musk Lorikeet", "Peregrine Falcon", "Pied Cormorant", "Red-capped Plover", "Red-necked Stint", "Silver Gull", "Sooty Oystercatcher", "Sulphur-crested Cockatoo", "Welcome Swallow", "White-bellied Sea-Eagle"],
  },
  "Woods Bushland Reserve": {
    totalRecords: 317,
    peakMonths: [1, 2, 3],
    topSpecies: [{"name":"Varied Sittella","count":20,"peakMonths":[1, 3, 8],"behaviors":[]}, {"name":"Eastern Yellow Robin","count":18,"peakMonths":[3, 2, 5],"behaviors":[]}, {"name":"Flame Robin","count":17,"peakMonths":[9, 5, 7],"behaviors":[]}, {"name":"Satin Flycatcher","count":16,"peakMonths":[2, 1, 12],"behaviors":[]}, {"name":"Sacred Kingfisher","count":15,"peakMonths":[1, 12, 2],"behaviors":[]}, {"name":"Dusky Woodswallow","count":13,"peakMonths":[2, 9, 1],"behaviors":[]}, {"name":"Crimson Rosella","count":13,"peakMonths":[3, 1, 8],"behaviors":[]}, {"name":"Gray Shrikethrush","count":12,"peakMonths":[2, 1, 5],"behaviors":[]}, {"name":"White-eared Honeyeater","count":11,"peakMonths":[2, 1, 3],"behaviors":[]}, {"name":"White-naped Honeyeater","count":11,"peakMonths":[2, 1, 5],"behaviors":[]}],
    allSpecies: ["Australian Hobby", "Australian King-Parrot", "Australian Magpie", "Australian Rufous Fantail", "Australian Shelduck", "Bassian Thrush", "Bell Miner", "Brown Goshawk", "Brown Thornbill", "Brown-headed Honeyeater", "Brush Bronzewing", "Common Bronzewing", "Crimson Rosella", "Dusky Woodswallow", "Eastern Rosella", "Eastern Shrike-tit", "Eastern Spinebill", "Eastern Yellow Robin", "Fan-tailed Cuckoo", "Flame Robin", "Galah", "Golden Whistler", "Golden Whistler (Eastern)", "Gray Butcherbird", "Gray Fantail", "Gray Shrikethrush", "Laughing Kookaburra", "Little Wattlebird", "Maned Duck", "Mistletoebird", "New Holland Honeyeater", "Olive-backed Oriole", "Rainbow Lorikeet", "Red Wattlebird", "Red-browed Firetail", "Rufous Whistler", "Sacred Kingfisher", "Satin Flycatcher", "Spotted Dove", "Spotted Pardalote", "Striated Pardalote", "Striated Thornbill", "Sulphur-crested Cockatoo", "Tawny Frogmouth", "Tree Martin", "Varied Sittella", "Wedge-tailed Eagle", "White-browed Scrubwren", "White-eared Honeyeater", "White-naped Honeyeater"],
  },
  "Mushroom Reef Marine Sanctuary": {
    totalRecords: 131,
    peakMonths: [4, 12, 1],
    topSpecies: [{"name":"Red-necked Stint","count":21,"peakMonths":[4, 12, 10],"behaviors":[]}, {"name":"Hooded Plover","count":20,"peakMonths":[4, 12, 1],"behaviors":[]}, {"name":"Ruddy Turnstone","count":17,"peakMonths":[4, 12],"behaviors":[]}, {"name":"Sooty Oystercatcher","count":14,"peakMonths":[3, 4, 12],"behaviors":[]}, {"name":"Double-banded Plover","count":11,"peakMonths":[4],"behaviors":[]}, {"name":"Kelp Gull","count":8,"peakMonths":[4],"behaviors":[]}, {"name":"Pacific Gull","count":7,"peakMonths":[11, 4, 3],"behaviors":[]}, {"name":"Australian Ibis","count":5,"peakMonths":[12, 2, 1],"behaviors":[]}, {"name":"Chestnut Teal","count":4,"peakMonths":[12, 2, 4],"behaviors":[]}, {"name":"Great Crested Tern","count":4,"peakMonths":[11, 1],"behaviors":[]}],
    allSpecies: ["Australian Ibis", "Australian Magpie", "Chestnut Teal", "Double-banded Plover", "Great Crested Tern", "Hooded Plover", "Kelp Gull", "Little Black Cormorant", "Little Raven", "Little Wattlebird", "Magpie-lark", "Nankeen Kestrel", "Pacific Gull", "Pied Cormorant", "Red-necked Stint", "Ruddy Turnstone", "Silver Gull", "Singing Honeyeater", "Sooty Oystercatcher", "Superb Fairywren", "Swamp Harrier", "White-faced Heron", "Willie-wagtail"],
  },
  "Hastings Jetty": {
    totalRecords: 119,
    peakMonths: [1, 8, 2],
    topSpecies: [{"name":"Australian Pelican","count":42,"peakMonths":[1, 2, 8],"behaviors":[]}, {"name":"Royal Spoonbill","count":13,"peakMonths":[8, 1, 3],"behaviors":[]}, {"name":"Little Pied Cormorant","count":8,"peakMonths":[1, 11, 8],"behaviors":[]}, {"name":"Pacific Gull","count":8,"peakMonths":[8, 2, 1],"behaviors":[]}, {"name":"Great Egret","count":7,"peakMonths":[1, 3, 12],"behaviors":[]}, {"name":"Pied Cormorant","count":7,"peakMonths":[1, 12, 11],"behaviors":[]}, {"name":"Australian Ibis","count":6,"peakMonths":[1, 8, 2],"behaviors":[]}, {"name":"White-faced Heron","count":5,"peakMonths":[1, 12, 8],"behaviors":[]}, {"name":"Black Swan","count":4,"peakMonths":[11, 8, 4],"behaviors":[]}, {"name":"Silver Gull","count":3,"peakMonths":[4, 2, 1],"behaviors":[]}],
    allSpecies: ["Australian Ibis", "Australian Pelican", "Black Swan", "Caspian Tern", "Crested Pigeon", "Galah", "Gray Teal", "Great Crested Tern", "Great Egret", "Hoary-headed Grebe", "Little Black Cormorant", "Little Pied Cormorant", "Little Raven", "Magpie-lark", "Masked Lapwing", "Pacific Gull", "Pied Cormorant", "Pied Oystercatcher", "Red Wattlebird", "Royal Spoonbill", "Silver Gull", "White-faced Heron"],
  },
};
...
const rateLocation = (loc, hour, mode, wx, marine, sightings=[], month=new Date().getMonth()+1) => {
  ...
  if(mode === "wildlife") {
    ...
    const mlIntel = ML_LOCATION_INTEL[loc.name];
    if(mlIntel){
      const ispeakMonth = mlIntel.peakMonths.includes(month);
      if(ispeakMonth){ score += 2; reasons.push(`Peak month here — ${mlIntel.totalRecords} community records`); }
      else { score += 0.5; }
      // Flag breeding behaviors from ML data
      const breedingBehaviors = ["Nest Building","Feeding Young","Carrying Food","Courtship"];
      const topBehaviors = mlIntel.topSpecies.flatMap(s => s.behaviors || []);
      const hasBreeding = topBehaviors.some(b => breedingBehaviors.some(bb => b.includes(bb)));
      if(hasBreeding){ score += 1; reasons.push("Breeding activity confirmed at this location"); }
    }
...
`}
MACAULAY LIBRARY DATA (10,000 records from community photographers on the Peninsula):
${focusLoc && ML_LOCATION_INTEL[focusLoc.name] ? (()=>{
  const ml = ML_LOCATION_INTEL[focusLoc.name];
  const curMonth = date.getMonth()+1;
  const likelyNow = ml.topSpecies.filter(s=>s.peakMonths.includes(curMonth)).map(s=>s.name);
  const allTime = ml.topSpecies.map(s=>`${s.name} (${s.count} records, peak months: ${s.peakMonths.map(m=>["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"][m]).join("/")}${s.behaviors.length?" — behaviours: "+s.behaviors.join(", "):""})`);
  const rarer = ml.allSpecies.filter(s=>!ml.topSpecies.map(t=>t.name).includes(s)).slice(0,20);
  return `Location: ${ml.totalRecords} total records | Peak months: ${ml.peakMonths.map(m=>["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"][m]).join(", ")}
LIKELY THIS MONTH (peak species for month ${curMonth}): ${likelyNow.length ? likelyNow.join(", ") : "check all-time list"}
ALL-TIME TOP SPECIES: ${allTime.slice(0,12).join("; ")}
OTHER RECORDED SPECIES: ${rarer.join(", ")}`;
})() : focusLoc ? `No ML data for this specific location — use eBird and sightings below.` : `See location-specific data when a location is selected.`}
...
2 sentences per section max. Use <ul><li> for any lists. Honest about poor conditions. No camera settings.`;
  ...
  const sendChat = async (msg) => {
    ...
    const mlSummary = Object.entries(ML_LOCATION_INTEL).map(([loc, d]) => {
      const peakNow = d.topSpecies.filter(s=>s.peakMonths.includes(month)).map(s=>s.name);
      return `${loc}: ${peakNow.length?'PEAK NOW — '+peakNow.join(', ')+' | ':''} all-time top: ${d.topSpecies.slice(0,4).map(s=>s.name).join(', ')}`;
    }).join("\n");
...
MACAULAY LIBRARY INTELLIGENCE (10,000 Peninsula records — use this to answer species/location questions):
${mlSummary}
...
When answering species location questions (e.g. "where can I find X today"), cross-reference ML data, Matt's sightings, and eBird. Cite which source supports your answer. Be direct and concise — he's a professional, skip the basics. Use HTML for structure if helpful (h4, ul/li tags). Keep responses under 300 words.`;
